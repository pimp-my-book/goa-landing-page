<template>
    <header class="w-full lg:h-64 s:h-82 bg-green-gradient text-center lg:rounded-header-border s:header-border-sm">
   <DisplayXLarge
   :text="HeaderText"
   ...
   />
    <FeatureText
    :text="BodyText"
    class="text-black pt-5 lg:px-32 Feature__Text"
    />
    </header>
</template>    
<script> 
