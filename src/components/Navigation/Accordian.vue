    ...
    <div class="bg-white shadow-md mt-5 lg:w-3/4 lg:text-left s:text-center">
       ...
       <!-- Start of FAQ -->
        ...
        <div class="flex flex-row">
            ...
            <label for="toggle2" class="lg:w-4/5 s:w-16 p-10">
            <DisplaySmall
...
<!-- End of FAQ -->
       ...
       <div class="border-b border-gray-500">
        ...
        <div class="flex flex-row">
            ...
            <label for="toggle3" class="lg:w-4/5 s:w-16 p-10">
            <DisplaySmall
       ...
       <div class="border-b border-gray-500">
        ...
        <div class="flex flex-row">
            ...
            <label for="toggle4" class="lg:w-4/5 s:w-16 p-10">
            <DisplaySmall
...
<!-- Start of FAQ -->
       <div class="border-b border-gray-500">
        ...
        <div class="flex flex-row">
            ...
            <label for="toggle5" class="lg:w-4/5 s:w-16 p-10">
            <DisplaySmall
       ...
       <div class="border-b border-gray-500">
        ...
        <div class="flex flex-row">
            ...
            <label for="toggle6" class="lg:w-4/5 s:w-16 p-10">
            <DisplaySmall
       ...
       <div class="border-b border-gray-500">
        ...
        <div class="flex flex-row">
            ...
            <label for="toggle7" class="lg:w-4/5 s:w-16 p-10">
            <DisplaySmall
